...
import 'package:learning_bloc/ToDoApp/blocs/todo_bloc/todo_bloc.dart';
import 'package:learning_bloc/ToDoApp/blocs/todo_bloc/todo_events.dart';
...
import 'package:learning_bloc/ToDoApp/models/to_do_model.dart';
import 'package:learning_bloc/ToDoApp/screens/add_todo_screen.dart';
      ...
      child: Scaffold(
        appBar: AppBar(
          bottom: TabBar(
              onTap:(tabIndex){
                if(tabIndex == 0){
                  BlocProvider.of<TodoFilterBloc>(context).add(UpdateToDoFilterEvent(
